      ...
      <section className='space-y-16'>
        ...
        <div>
          ...
          <ul className='space-y-4 opacity-80 leading-relaxed'>
            {[
              ...
              '/types for your typescript types',
            ].map((a, i) => (
        ...
        <div>
          ...
          <p className='opacity-80 leading-relaxed'>
            Copy the file{' '}
            <span className='text-base-content font-medium'>.env.example</span>{' '}
            and rename it to{' '}
            <span className='text-base-content font-medium'>.env.local</span>{' '}
            for development and{' '}
            <span className='text-base-content font-medium'>.env</span> in
            production. Please note that you should not commit those to GitHub.
            <br />
